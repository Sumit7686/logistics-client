...
export default function DropAtStore() {
      ...
      <div className="partner-body container">
        <div className="row my-4">
          <div className="col-md-6">
            <div className="h1">DROP AT STORE</div>
            <div className="partnerbody-content p mt-4">
              Our Drop at Store (DAS) program enables small businesses and local
              retailers to provide pick-up and delivery capacity to the
              Delhivery network in cities serviced by our express network.
              Partners can add an extra revenue stream to their business with
              zero additional investment by signing up to receive orders from
              Delhivery, provide pick-up and delivery services or act as pick-up
              and delivery points in local areas from customers within 2-3 km of
              their operations. Delhivery's store program currently enables over
        ...
        <div className="container">
          <div className="row text-center mt-4">
            <div className="col-md-4">
              ...
              <span className="p">Sign up for DAS</span>
            </div>
            <div className="col-md-4">
              <img
